...
class _SSaveState extends State<SSave> {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Custom", style: context.textTheme?.titleSmall),
                  ],
                ),
              ),
            ),
  ...
  Widget mainView() {
    return Stack(
      ...
      children: [
        SizedBox.expand(
          child: Image.asset(filterList[selectedIndex], fit: BoxFit.cover),
        ),
        Positioned(
          right: -20,
          bottom: 40,
        ...
        // momo ai label. if user use free version user will see it.
        WAiLabel(),
      ],
    );
  }
